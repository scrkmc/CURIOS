    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboard.php">CRUD Using PHP/MySQL</a>
            </div>
                  ...
                  <h2>Detailed Records</h2>
                      <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="dashboard.php">
                            ...
                            <div class="form-group">
                              <input class="form-control" placeholder="Funds Allocated" name="funds_alloc" value="<?php echo $d; ?>">
                            </div> 
                            <div class="form-group">
                              <input class="form-control" placeholder="Sector" name="sector" value="<?php echo $d; ?>">
                            </div> 
